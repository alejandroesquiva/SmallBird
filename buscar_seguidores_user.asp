...
<!------------------------------------------------------------------------------------
Función mostrar_perfiles_seguidores(user)
...
sub mostrar_perfiles_seguidores(user)  
...
On Error Resume Next
 ...
 SQL1 = "SELECT users.nombre_usuario, seguidores.id_user_seguidor FROM users INNER JOIN seguidores ON users.Id_user = seguidores.Id_user WHERE (((users.nombre_usuario)="&Chr(39)&user&Chr(39)&")); "
  ...
  Do Until oRSx1.EOF
 	 ...
 	 SQL2 = "SELECT users.Id_user, users.nombre_usuario FROM users WHERE (((users.Id_user)="& oRSx1("id_user_seguidor")&")); "
...
<title>Busqueda Seguidores</title>
</head>
<body>
...
<div class="blogcomment">
 	<div class="blogwcommentwrap">  
    	<div align="center" class="contacttextarea">
            ...
            &gt;
            <a href="buscar_seguidores_user.asp?nombre_usuario=<%=Request.QueryString("nombre_usuario")%>">Seguidores de <b style="color:#F90"><%=Request.QueryString("nombre_usuario")%></b></a>
            </h4>
        </div>
	...
	if usuario_existente(Request.QueryString("nombre_usuario")) = "true" then
		...
		if (Request.QueryString("pag") = "")  then
			call mostrar_perfiles_seguidores(Request.QueryString("nombre_usuario"))
		else
			call mostrar_perfiles_seguidores(Request.QueryString("nombre_usuario"))
		end if
